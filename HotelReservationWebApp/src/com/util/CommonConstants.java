...
//This is the common constants file
public class CommonConstants {
	...
	// Constant for query tag in StaffQuery.xml
	public static final String TAG_NAME = "query";

	// Constant for query id in StaffQuery.xml
	public static final String ATTRIB_ID = "id";

	// Constant for staffId prefix
	...
	// Constant for query id of drop_table in StaffQuery.xml
	public static final String QUERY_ID_DROP_TABLE = "drop_table";

	// Constant for query id of create_table in StaffQuery.xml
	public static final String QUERY_ID_CREATE_TABLE = "create_staff_table";

	// Constant for query id of insert staff in StaffQuery.xml
	public static final String QUERY_ID_INSERT_STAFF = "insert_staff";

	// Constant for query id of get the staff in StaffQuery.xml
	public static final String QUERY_ID_GET_STAFF = "staff_by_id";

	// Constant for query id of get all staff in StaffQuery.xml
	public static final String QUERY_ID_ALL_STAFF = "all_staff";

	// Constant for query id of remove a staff in StaffQuery.xml
	public static final String QUERY_ID_REMOVE_STAFF = "remove_staff";

	// Constant for query id of update a staff in StaffQuery.xml
	public static final String QUERY_ID_UPDATE_STAFF = "update_staff";

	// Constant for query id of get all staff ids in StaffQuery.xml
	public static final String QUERY_ID_GET_STAFF_IDS = "staff_ids";
